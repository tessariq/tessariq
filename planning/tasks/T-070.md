...
Address verification finding `T-068-changelog`.
...
- 2026-04-03T10:27:46Z: Added CHANGELOG.md entry for T-068 atomic manifest writes; removed stale merge conflict marker. Verification passes with zero findings.
