...
This task addresses a gap in T-028's implementation. T-028 correctly scoped repair to disposable worktree paths but did not specify or pin the container image.
