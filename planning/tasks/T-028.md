...
Close the remaining T-027 gaps by streaming container output into the host tmux session via `run.log`, and by making disposable worktree cleanup reliable after non-host container writes.
...
- Existing T-027 container lifecycle behavior remains intact.
...
- This task intentionally does not change proxy networking; T-012 still owns egress enforcement.
