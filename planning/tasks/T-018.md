...
- This task is safe to execute immediately after T-002 since it only modifies Config struct fields, flag definitions, and help text.
- Adapter tasks (T-008, T-009, T-010) are not yet implemented, so the rename has zero migration cost.
