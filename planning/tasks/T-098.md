...
- Keep the error style aligned with existing tampered-evidence failures from T-048 and T-089.
- Add this task to `T-017` dependencies so closeout cannot pass while proxy-evidence requirements are bypassable by manifest tampering.
