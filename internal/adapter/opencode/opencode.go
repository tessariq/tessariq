...
// DefaultImage is the default container image for the OpenCode agent.
...
// Process implements runner.ProcessRunner for the OpenCode agent.
type Process struct {
	args      []string
	image     string
...
// New creates an OpenCode agent process from the run configuration.
