...
func TestNewProcess_ClaudeCode(t *testing.T) {
	...
	ap, err := NewProcess(cfg, "implement feature", "run-1", "/wt", "/ev",
		nil, nil, authmount.AuthMountModeReadOnly, 0, "disabled", "disabled", nil, nil, "open", UpdateResult{})
...
func TestNewProcess_ClaudeCode_WithEnvVars(t *testing.T) {
	...
	ap, err := NewProcess(cfg, "implement feature", "run-1", "/wt", "/ev",
		nil, nil, authmount.AuthMountModeReadOnly, 0, "enabled", "mounted", envVars, nil, "open", UpdateResult{})
...
func TestNewProcess_AuthMountCount(t *testing.T) {
	...
	ap, err := NewProcess(cfg, "task", "run-1", "/wt", "/ev",
		authMounts, nil, authmount.AuthMountModeReadOnly, len(authMounts), "disabled", "disabled", nil, nil, "open", UpdateResult{})
...
func TestNewProcess_WithProxyEnv(t *testing.T) {
	...
	ap, err := NewProcess(cfg, "task", "run-1", "/wt", "/ev",
		nil, nil, authmount.AuthMountModeReadOnly, 0, "disabled", "disabled", nil, pEnv, "proxy", UpdateResult{})
...
func TestNewProcess_EgressNone_SetsNetworkNone(t *testing.T) {
	...
	cfg.TaskPath = "specs/task.md"
	ap, err := NewProcess(cfg, "task", "run-1", "/wt", "/ev",
		nil, nil, authmount.AuthMountModeReadOnly, 0, "disabled", "disabled", nil, nil, "none", UpdateResult{})
...
func TestNewProcess_WithSuccessfulUpdate_RuntimeInfo(t *testing.T) {
	...
	ap, err := NewProcess(cfg, "task", "run-1", "/wt", "/ev",
		nil, nil, authmount.AuthMountModeReadOnly, 0, "disabled", "disabled", nil, nil, "open", update)
