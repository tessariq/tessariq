...
- **Tessariq development policy:** [`docs/workflow/development-workflow.md`](docs/workflow/development-workflow.md).
...
Use the Taskrail version pinned in `mise.toml` and its vendored skills for
tracked-work operations. Never hand-edit managed `planning/STATE.md` state or
task status fields. Commit generated planning changes in the same commit as the
